output "eks-admin-role" {
  description = "Output the eks sso role for platform admins"
  value       = data.aws_iam_roles.eks-admin-sso.arns
}

output "vpc_private_subnet_cidr" {
  description = "VPC private subnet CIDR"
  value       = module.aws-vpc.private_subnets_cidr_blocks
}

output "vpc_public_subnet_cidr" {
  description = "VPC public subnet CIDR"
  value       = module.aws-vpc.public_subnets_cidr_blocks
}
